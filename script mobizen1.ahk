...
Gui, Add, Text, x345 y3 h20 w180 vTxT_NbrRep, Energie r�ante :
Gui, Add, Edit, x430 y0 w70 h21 vEdit_NbrRep gSubmit
Gui, Add, UpDown, vNbrRep gSubmit Range0-999, 0

Gui, Add, Text, x345 y28 h20 w180 vTxT_Prix, Prix en �rgie   :
...
Gui,add, Text,x85 y55 h20 w180 vRep, Nombre de r�titions :
...
IfWinExist, Mobizen Mirroring
{
	...
	If Box = 0
	{
		...
		{
			repe++
			GuiControl,,Rep , R�titions effectuer : %repe%/%NbrRep%
			A := X
			B := Y
			X += 816
			Y += -14
...
If (Started == 0)
{
	...
	GuiControl,,Tps , Temps d'execution : %Tpsx%
	GuiControl,, Rep, Nombre de r�titions : %NbrRep%
