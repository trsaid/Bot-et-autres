; ====== ====== ====== ====== ====== ======
; Task:
; 	Number Reversal Game @ RosettaCode
; Language:
; 	AutoHotkey
; Link:
; 	http://rosettacode.org/wiki/Number_reversal_game#AutoHotkey
; Date:
; 	10/APR/2010
; Author:
...
ScrambledList := CorrectList := "1 2 3 4 5 6 7 8 9" ; Declare two identical strings
